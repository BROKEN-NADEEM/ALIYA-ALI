...
def meyexudi():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('espeak -a 300 " Assalamualaikum,   I,   Am,    Robot,   of,   ALIYA,   NADEEM ,    Please,   Send,   Your,   Key,"')
      print(" \x1b[0m║══[KEY]  : "+id)
      ...
      tks = ('Hello%20NADEEM Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+917209101285?text='+tks),approval()       
  except:
    sys.exit()
print(logo)
meyexudi()
